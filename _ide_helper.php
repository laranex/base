...
namespace Laranex\LaravelMyanmarPayments {
     ...
     */        class LaravelMyanmarPaymentsFacade {
                    /**
         * 
         *
         * @throws \Exception
        ...
        {
                        /** @var \Laranex\LaravelMyanmarPayments\LaravelMyanmarPayments $instance */
                        return $instance->channel($channel);
        }
            }
    }
...
namespace  {
            ...
            class LaravelMyanmarPayments extends \Laranex\LaravelMyanmarPayments\LaravelMyanmarPaymentsFacade {}
