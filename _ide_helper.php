...
')
     ...
     *
     */ 
        class LaravelMyanmarNrcFacade {
                    /**
         * 
         *
         * @static 
         */ 
        public static function isValidMyanmarNRC($nrc)
        {
                        /** @var \laranex\LaravelMyanmarNRC\LaravelMyanmarNrc $instance */
                        return $instance->isValidMyanmarNRC($nrc);
        }
...
namespace  { 
            ...
            class LaravelMyanmarNrc extends \laranex\LaravelMyanmarNRC\LaravelMyanmarNrcFacade {}
